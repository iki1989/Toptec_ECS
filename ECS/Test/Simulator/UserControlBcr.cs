...
namespace Simulator
{
    public partial class UserControlBcr : UserControl
    {
        ...
        public UserControlBcr(string name, int port) : base()
        {
            InitializeComponent();
        ...
        {
            string text = this.textBoxWeight.Text;
    ...
    public class SimulatorBcr : TcpCommunicator
    {
        private const char STX = (char)0x02;
        private const char ETX = (char)0x03;

        public SimulatorBcr(object owner) : base(owner) { }
