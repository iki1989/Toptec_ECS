...
namespace Simulator
{
    ...
    {
        private SimulatorZebraZe500 simnulator;

        public UserControlZebraZe500(string name, int port) : base()
        {
            InitializeComponent();
            this.groupBox1.Text = name;

            this.simnulator = new SimulatorZebraZe500(this);
    ...
    public class SimulatorZebraZe500 : TcpCommunicator
    {
        public SimulatorZebraZe500(object owner) : base(owner) { }
