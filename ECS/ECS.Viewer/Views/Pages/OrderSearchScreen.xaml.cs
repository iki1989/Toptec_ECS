...
{
    /// <summary>
    /// Interaction logic for OrderSearchScreen.xaml
    /// </summary>
    public partial class OrderSearchScreen : Page
    {
        private OrderSearchViewModel ViewModel => (OrderSearchViewModel)DataContext;
        private SharpTimer midNightTimer = new SharpTimer(0, 0, 0);

        public OrderSearchScreen()
        {
            InitializeComponent();
