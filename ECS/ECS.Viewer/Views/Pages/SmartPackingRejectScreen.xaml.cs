...
{
    /// <summary>
    /// Interaction logic for InvoiceRejectScreen.xaml
    /// </summary>
    public partial class SmartPackingRejectScreen : Page
    {
        private SmartPackingRejectViewModel ViewModel => (SmartPackingRejectViewModel)DataContext;
        private SharpTimer midNightTimer = new SharpTimer(0, 0, 0);

        public SmartPackingRejectScreen()
        {
            InitializeComponent();
