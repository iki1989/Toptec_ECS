...
namespace ECS.Viewer.Views.Pages
{
    ...
    /// </summary>
    public partial class TrackingLogSearchScreen : Page
    {
        private TrackingLogSearchViewModel ViewModel => (TrackingLogSearchViewModel)DataContext;
        private SharpTimer midNightTimer = new SharpTimer(0, 0, 0);

        public TrackingLogSearchScreen()
        {
            InitializeComponent();
